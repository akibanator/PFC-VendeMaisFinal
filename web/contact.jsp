                                ...
                                <div class="row">  
                                    <div class="col-sm-12 col-md-6 contact_left">        
                                        <form class="form-horizontal" method="post" action="#">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" rows="4" name="mensagem" placeholder="MENSAGEM..." required></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 contact_right">
                                        ...
                                        <div class="col-md-12 contact_info">
                                            <a href="mailto:info@company.com" class="contact-info-link">
                                                <i class="fa fa-envelope contact-fa"></i>faleconosco@vendemais.com
                                                <br/>                                            
                                                <i class="fa fa-mobile contact-fa"></i>(11) 91245-7890
                                                <br/>
