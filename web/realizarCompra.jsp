                            ...
                            <div class="contact-content-upper">
                                ...
                                <div class="row">  
                                    <div class="col-sm-12 col-md-6 contact_left">   
                                        ...
                                        <hr>
                                        <SCRIPT src="js/validaçãoQuantidade.js"></SCRIPT>
                                            <%
                                            ...
                                            <table width=50%>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="quantidadeDesejada" size=10 id="quantidadeDesejada" quantidadeDesejada required></td>
                                                    </tr>
                                                <input hidden type="text" name="idAnuncio" value="<%=anuncio.getId()%>">
                                                ...
                                                <input hidden type="text" name="quantidade" id="quantidade" value="<%=anuncio.getQuantidade()%>">
