                                    ...
                                    <div class="row">                                        
                                        <table>
                                            ...
                                            <tr>   
                                                ...
                                                <td width="25%"><b><button type="button" data-toggle="modal" data-target="#myModal<%=historico.getId()%>">Detalhes do Produto</button></p>
                                                        <!-- Modal -->
                                                        ...
                                                        <td width="25%"><b><button type="button" data-toggle="modal" data-target="#myModal1<%=historico.getId()%>">Detalhes do Produto</button></p>
                                                        <!-- Modal -->
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td colspan="5" align="left" valign="top" style="color:#404041;font-size:12px;line-height:16px;padding:5px 5px 3px 5px;border-bottom:dashed 1px #e5e5e5">
                                                                                                                <%%>
                                                                                                                <input hidden type="text" id="produtoC" name="produtoC" value="<%%>">
                                                                                                            </td>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td colspan="4" align="left" valign="top" width="115" style="color:#ff6600;font-size:12px;padding:10px 5px 0px 5px">
                                                                                                                <%%>
                                                                                                                <input hidden type="text" id="vendedor" name="vendedor" value="<%%>">
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td width="15">&nbsp;
                                                                                                            ...
                                                                                                            <td colspan="4" align="left" valign="top" style="color:#404041;font-size:12px;padding:5px 5px 0px 5px">
                                                                                                                <%%>
                                                                                                                <input hidden type="text" id="Fenvio" name="Fenvio" value="<%%>">
                                                                                                            </td> 
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td width="15">&nbsp;
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="62" align="right" valign="top" style="color:#404041;font-size:12px;line-height:16px;padding:5px 5px 3px 5px;border-bottom:solid 1px #999999">
                                                                                                <input type="text" style="border:0;" id="envi" name="envi" readonly="" required value="R$<%%>">
                                                                                                <input type="text" style="border:0;" id="env" name="env" hidden required value="<%%>">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
